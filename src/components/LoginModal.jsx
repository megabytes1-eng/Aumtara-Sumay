...
export default function LoginModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-900 w-full max-w-lg rounded-3xl border-4 border-indigo-600 dark:border-indigo-500 shadow-indigo-500/20 shadow-2xl p-6 sm:p-8 space-y-6 animate-fadeIn text-slate-900 dark:text-slate-100 max-h-[95vh] overflow-y-auto">
