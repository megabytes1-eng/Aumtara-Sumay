...
export const initialTeachers = [
  // Morning Shift Faculty
  {
    ...
    email: "robert.l@apex.edu",
    phone: "+1 555-0101",
    primarySubjectId: "SUB-101",
    secondarySubjectIds: ["SUB-102", "SUB-201"],
    substituteSubjectIds: ["SUB-105"],
    subjects: ["SUB-101", "SUB-102", "SUB-201", "SUB-105"],
    maxDaily: 5,
    maxWeekly: 24,
    offDay: "Saturday",
    shift: "Morning Shift"
  },
  {
    ...
    email: "eleanor.v@apex.edu",
    phone: "+1 555-0102",
    primarySubjectId: "SUB-102",
    secondarySubjectIds: ["SUB-103", "SUB-104"],
    substituteSubjectIds: ["SUB-202"],
    subjects: ["SUB-102", "SUB-103", "SUB-104", "SUB-202"],
    maxDaily: 5,
    maxWeekly: 22,
    offDay: "None",
    shift: "Morning Shift"
  },
  {
    id: "TCH-03",
    name: "Dr. Alan Turing",
    email: "alan.t@apex.edu",
    phone: "+1 555-0103",
    primarySubjectId: "SUB-106",
    secondarySubjectIds: ["SUB-101"],
    substituteSubjectIds: ["SUB-201"],
    subjects: ["SUB-106", "SUB-101", "SUB-201"],
    maxDaily: 5,
    maxWeekly: 24,
    offDay: "Wednesday",
    shift: "Both Shifts"
  },
  {
    ...
    email: "marie.c@apex.edu",
    phone: "+1 555-0104",
    primarySubjectId: "SUB-104",
    secondarySubjectIds: ["SUB-102", "SUB-202"],
    substituteSubjectIds: ["SUB-103"],
    subjects: ["SUB-104", "SUB-102", "SUB-202", "SUB-103"],
    maxDaily: 5,
    maxWeekly: 22,
    offDay: "None",
    shift: "Morning Shift"
  },
  {
    id: "TCH-05",
    name: "Ms. Jane Austen",
    email: "jane.a@apex.edu",
    phone: "+1 555-0105",
    primarySubjectId: "SUB-105",
    secondarySubjectIds: ["SUB-203", "SUB-205"],
    substituteSubjectIds: ["SUB-204"],
    subjects: ["SUB-105", "SUB-203", "SUB-205", "SUB-204"],
    maxDaily: 5,
    maxWeekly: 25,
    offDay: "Friday",
    shift: "Morning Shift"
  ...
  {
    id: "TCH-201",
    name: "Prof. Ramanujan Sharma",
    email: "ramanujan.s@state.edu",
    phone: "+1 555-0201",
    primarySubjectId: "SUB-201",
    secondarySubjectIds: ["SUB-101", "SUB-202"],
    substituteSubjectIds: ["SUB-106"],
    subjects: ["SUB-201", "SUB-101", "SUB-202", "SUB-106"],
    maxDaily: 5,
    maxWeekly: 24,
    offDay: "Monday",
  ...
  },
  {
    ...
    email: "vikram.s@state.edu",
    phone: "+1 555-0202",
    primarySubjectId: "SUB-202",
    secondarySubjectIds: ["SUB-102", "SUB-104"],
    substituteSubjectIds: ["SUB-201"],
    subjects: ["SUB-202", "SUB-102", "SUB-104", "SUB-201"],
    maxDaily: 5,
    maxWeekly: 22,
    offDay: "None",
    shift: "Afternoon Shift"
  ...
  {
    id: "TCH-203",
    name: "Ms. Arundhati Roy",
    email: "arundhati.r@state.edu",
    phone: "+1 555-0203",
    primarySubjectId: "SUB-203",
    secondarySubjectIds: ["SUB-105", "SUB-205"],
    substituteSubjectIds: ["SUB-204"],
    subjects: ["SUB-203", "SUB-105", "SUB-205", "SUB-204"],
    maxDaily: 5,
    maxWeekly: 24,
    offDay: "Thursday",
    shift: "Afternoon Shift"
  ...
  {
    id: "TCH-204",
    name: "Mr. B.R. Ambedkar",
    email: "br.a@state.edu",
    phone: "+1 555-0204",
    primarySubjectId: "SUB-204",
    secondarySubjectIds: ["SUB-203", "SUB-205"],
    substituteSubjectIds: ["SUB-105"],
    subjects: ["SUB-204", "SUB-203", "SUB-205", "SUB-105"],
    maxDaily: 5,
    maxWeekly: 24,
    offDay: "Wednesday",
    shift: "Afternoon Shift"
  ...
  {
    id: "TCH-205",
    name: "Mr. Rabindranath Tagore",
    email: "rabindra.t@state.edu",
    phone: "+1 555-0205",
    primarySubjectId: "SUB-205",
    secondarySubjectIds: ["SUB-203"],
    substituteSubjectIds: ["SUB-204"],
    subjects: ["SUB-205", "SUB-203", "SUB-204"],
    maxDaily: 4,
    maxWeekly: 20,
    offDay: "Friday",
    shift: "Afternoon Shift"
  ...
  {
    id: "TCH-206",
    name: "Coach Dhyan Chand",
    email: "dhyan.c@state.edu",
    phone: "+1 555-0206",
    primarySubjectId: "SUB-206",
    secondarySubjectIds: [],
    substituteSubjectIds: ["SUB-205"],
    subjects: ["SUB-206", "SUB-205"],
    maxDaily: 4,
    maxWeekly: 18,
    offDay: "Tuesday",
    shift: "Afternoon Shift"
